<?php
    ...
    if ($result) {
        ...
        $_SESSION['contentid'] = $randomRow['id'];
        $_SESSION['content'] = $randomRow['content'];
        $_SESSION['like'] = $randomRow['likes'];
        $_SESSION['dlike'] = $randomRow['dlikes'];
      ...
      <div class="login-wrapper">
            ...
            <div class="icons-box">
                ...
                <div class="icons">
                    <label class="btn-label" for="dislike-checkbox">
                        ...
                        <span class="dislike-text-content">
                            <?php
                                $dlike = $_SESSION['dlike'];
                                echo "$dlike";
                            ?>
                        </span>
                    </label>
        ...
        <div class="social-buttons">
            <a href="#" class="social-button add" onclick='addcontent()'>
                ...
                <div class='view addview'>Add Content</div>
            </a>
            <a href="#" class="social-button home" onclick='home()'>
                ...
                <div class='view homeview'>Go To Home</div>
            </a>
        ...
        <script>
            ...
            function liked() {
                window.location.href = '../process/liked.php';
            }
            function dliked() {
                window.location.href = '../process/dliked.php';
            }
            ...
            document.getElementById('like-checkbox').addEventListener('click', function() {
                setTimeout(liked, 1000);
            });
            document.getElementById('dislike-checkbox').addEventListener('click', function() {
                setTimeout(dliked, 1000);
            });
        </script>
    </form>
  </body>
